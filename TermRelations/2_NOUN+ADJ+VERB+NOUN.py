...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 18:09:23 2020
...
for i in range(len(postaglist)):
    if('NOUN' == postaglist[i] and 'ADJ'== postaglist[i+1]): #cuando encuentra noun, posnoun vale la posicion de la lista, (1) en el primer caso
        posnoun=i
        posnoun2=i+1
...
with open('data/NOUNADJ_resultlist.txt', 'w') as f2:
    for item in resultlist:
        f2.write("%s\n" % item)
    f2.close()
    
with open('data/NOUNADJ_verbrangelist.txt', 'w') as f2:
